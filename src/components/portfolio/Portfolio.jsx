    ...
    <section id='portfolio'>
      ...
      <article className='portfolio_item'>
        ...
        <article className='portfolio_item'>
          ...
          <div className="portfolio_item-cta">
            <a href="https://github.com/ayushbhatt14257/mernbusiness" className='btn' target='_new'>Github</a>
            <a href="https://mernbusiness.onrender.com" className='btn btn-primary' target='_new'>Live Demo</a>
          </div>
        </article>
        ...
        <article className='portfolio_item'>
          ...
          <h3>React infinte scroll website which render random images</h3>
          <div className="portfolio_item-cta">
            <a href="https://github.com/ayushbhatt14257/focus-academy" className='btn' target='_new'>Github</a>
            <a href="https://focus-academy.onrender.com" className='btn btn-primary' target='_new'>Live Demo</a>
          </div>
        </article>
        ...
        <article className='portfolio_item'>
          ...
          <div className="portfolio_item-cta">
            <a href="https://github.com/ayushbhatt14257/mern_project" className='btn' target='_new'>Github</a>
            <a href="https://mern-project-a2sp.onrender.com" className='btn btn-primary' target='_new'>Live Demo</a>
          </div>
        </article>
        ...
        <article className='portfolio_item'>
          ...
          <div className="portfolio_item-cta">
            <a href="https://github.com/ayushbhatt14257/mern-project" className='btn' target='_new'>Github</a>
        ...
        <article className='portfolio_item'>
          ...
          <div className="portfolio_item-cta">
            <a href="https://github.com/ayushbhatt14257/react-todo-list" className='btn' target='_new'>Github</a>
            <a href="https://todoayush.herokuapp.com/" className='btn btn-primary' target='_new'>Live Demo</a>
          </div>
        </article>
        ...
        <article className='portfolio_item'>
          ...
          <div className="portfolio_item-cta">
            <a href="https://github.com/ayushbhatt14257/Tic-tac-toe" className='btn' target='_new'>Github</a>
            {/* <a href="https://ayushmernweb.herokuapp.com" className='btn btn-primary' target='_blank'>Live Demo</a> */}
          </div>
        </article>
      </div>
